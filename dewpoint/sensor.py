...
#        Td = (241.88 * Td) / (17.558 - Td)
        ...
        Pws = (
            if Tf < 32 :
              math.exp(C1 / Tf + C2 + C3 * Tf + C4 * Tf**2 + C5 * Tf**3 + C6 * Tf**4 + C7 * math.log(Tf))
            else:
              math.exp(C8 / Tf + C9 + C10 * Tf + C11 * Tf**2 + C12 * Tf**3 + C13 * math.log(Tf))
        )
            
        lnPw = math.log(Rh * Pws)
        
        Td = (
            if Tf < 32 :
                90.12 + 26.412 * lnPw + 0.8927 * lnPw**2
            else :
                100.45 + 33.193 * lnPw + 2.319 * lnPw**2 + 0.17074 *lnPw**3 + 1.2063 * lnPw**0.1984
        )
        return Td
